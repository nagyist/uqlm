...
class UQEnsemble(UncertaintyQuantifier):
    def __init__(
        ...
        scorers : List containing instances of BaseChatModel, LLMJudge, black-box scorer names from ['semantic_negentropy', 'noncontradiction', 'exact_match', 'bert_score', 'cosine_sim', 'entailment'], or white-box scorer names from ["normalized_probability", "min_probability"] default=None
